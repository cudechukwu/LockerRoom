...
-- Coach ID: 8d99f216-1454-4500-9652-f87922774f5c
...
SELECT 
    ...
    is_coach_or_admin(
        'ddced7b8-e45b-45f9-ac31-96b2045f40e8'::UUID,  -- team_id
...
SELECT 
    ...
    CASE 
        WHEN is_user_in_team('ddced7b8-e45b-45f9-ac31-96b2045f40e8'::UUID, 'e163e9b2-55ea-49aa-a8e7-3c83bf550d74'::UUID)
...
SELECT 
    ...
    is_coach_or_admin('ddced7b8-e45b-45f9-ac31-96b2045f40e8'::UUID, auth.uid()) as coach_check,
    is_user_in_team('ddced7b8-e45b-45f9-ac31-96b2045f40e8'::UUID, 'e163e9b2-55ea-49aa-a8e7-3c83bf550d74'::UUID) as player_check,
    CASE 
        WHEN is_coach_or_admin('ddced7b8-e45b-45f9-ac31-96b2045f40e8'::UUID, auth.uid())
